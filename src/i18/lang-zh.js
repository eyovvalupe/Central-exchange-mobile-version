export default {
  ...
  account: {
    ...
    no_kyc_con2: "请先认证再添加收款地址",

    no_kyc_confirm: "去认证",
    no_google_title: "谷歌验证器未绑定",
    no_google_con1: "您的谷歌验证器还未绑定",
    no_google_con2: "请先绑定再添加收款地址",

    no_google_confirm: "去绑定",
    add_account_btn: "添加收款地址",
    delete_dialog_title: "删除账户",
    delete_dialog_con: "确认删除该收款地址吗？",
    delete_success: "成功删除",
    copy_address: "成功复制支付地址",
    add_page_title: "添加收款地址",
    add_tab1: "加密货币",
    add_tab2: "银行卡",
  ...
  trade: {
    ...
    stock_opening_err_stock: "请选择ETF",
    ...
    order_info_title_stock: "ETF订单",
    order_info_title_contract: "合约订单",
    order_info_available_stock: "可售ETF",
  ...
  market: {
    ...
    market_optional_recommend_stock: "推荐ETF",
    ...
    market_buy_fast_account_add: "添加收款地址",
    ...
    market_buy_list_firt_select: "请选择先添加收款地址",
