export default {
  common: {
    ...
    no_link_google: 'Google Authenticator not linked, link now?',
    kyc_verify_title: 'Real Name Authentication',
    kyc_verify_con: 'Kyc not passed, authenticate now?',
  },
  login: {
    login: 'Log In',
    email: 'Email',
  ...
  market: {
    ...
    market_marketinfo_high: '24h High',
    market_marketinfo_amount: 'Volume',
    market_marketinfo_close: 'Close',
    market_marketinfo_low: '24h Low',
