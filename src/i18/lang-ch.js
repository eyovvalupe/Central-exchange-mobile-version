export default {
  common: {
    ...
    no_link_google: '谷歌驗證器未綁定，去綁定？',
    kyc_verify_title: '實名認證',
    kyc_verify_con: "實名認證未通過，去認證？"
  },
  home: {
    login: '登录',
    loginDesc: '登入才能查看資產',
  ...
  trade: {
    ...
    stock_opening_err_stock: '請選擇ETF',
  ...
  market: {
    ...
    market_optional_recommend_stock: '推薦ETF',
