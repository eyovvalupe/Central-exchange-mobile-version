    ...
    <div style="background-color: #0E0F18;position: relative;">
        ...
        <div class="page-index">
            ...
            <div class="box top">
                ...
                <div class="title break all"><span style="color: #F19009;">{{ t('home.landing_con1') }}{{ t('home.landing_con2') }}</span><br />{{ t('home.landing_con3') }}</div>
                <div>{{ t('home.landing_con4') }}</div>
            </div>
            <div v-if="!token" class="ripple-btn login-btn" @click="jump('user', true)">{{ t('user_page.login_out') }}</div>
